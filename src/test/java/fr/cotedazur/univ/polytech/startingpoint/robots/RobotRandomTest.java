...
class RobotRandomTest {
    ...
    void showStatus() {
        ...
        assertEquals("\u001B[37m[Status of Bot avec 8 golds : role (Assassin" + robotRandom.getRESET() + "), 8 golds, hand {}, city {}]", robotRandom.statusOfPlayer(false));
        DistrictsType district = DistrictsType.BIBLIOTHEQUE;
        robotRandom.addDistrict(district);
        System.out.println(robotRandom.statusOfPlayer());
        assertEquals("\u001B[37m[Status of Bot avec 8 golds : role (Assassin" + robotRandom.getRESET() + "), 8 golds, hand {(Bibliothèque,6)}, city {}]", robotRandom.statusOfPlayer(false));
        robotRandom.tryBuild();
        System.out.println(robotRandom.statusOfPlayer());
        assertEquals("\u001B[37m[Status of Bot avec 8 golds : role (Assassin" + robotRandom.getRESET() + "), 2 golds, hand {}, city {(Bibliothèque,6)}]", robotRandom.statusOfPlayer(false));
    }
